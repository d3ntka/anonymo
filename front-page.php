            ...
            <div class="col-auto sponsors">
                ...
                <div class="row d-flex justify-content-end align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="<?php echo esc_html( $sponsor_link ); ?>"><img
                                src="<?php echo esc_url( $sponsor_logo['url'] ); ?>"
                                alt="<?php echo esc_attr( $sponsor_logo['alt'] ); ?>" /></a>
                        <?php else: ?>
        ...
        <div class="row about__sectionA">
            ...
            <div class="col-md-6">
                <div class="about__sectionA--text mx-auto my-auto">
                    ...
                    <h1 class="glitch" data-text="<?php echo esc_html( $about_title ); ?>">
                        <?php echo esc_html( $about_title ); ?></h1>
                    <?php endif; ?>
                    ...
                    <a href="<?php echo esc_html( $link_target ); ?>"
                        class="links"><span><?php echo esc_html( $link_name ); ?></span></a>
...
<section class="team pb-20">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-auto aligncenter">
                <h1 class="glitch" data-text="Drużyny" id="team">Drużyny</h1>
            </div>
        </div>
        <div class="row pb-5">
            <div class="col-12 col-md-8 aligncenter">
                <p>Ci wspaniali gracze tworzą trzon naszej organizacji. To właśnie z nimi przeżywacie największe
                    esportowe emocje. Poznajcie ich dokładniej i koniecznie wpadnijcie na przypięte social media!</p>
            </div>
        </div>
    </div>
    ...
    <?php if ( have_rows( 'team' ) ) : ?>
        ...
        <div class="container">
            ...
            <div class="swiper-container" id="swiper-teamsThumbs">
                <div class="swiper-wrapper">
                    <?php while ( have_rows( 'team' ) ) :
                    the_row(); 
                    if ( $team_name = get_sub_field( 'team_name' ) ) : 
                        $team_nr++;
                        ?>
                        <div class="swiper-slide">
                            <div class="team_name">
                                Drużyna <?php echo esc_html( $team_name ); ?>
                            </div>
    ...
    <?php if ( have_rows( 'team' ) ) : 
        // zagnieżdzone slidery do  wrapu drużyn, powyższy slider jest do przełączania pomiędzy drużynami
        ?>
    <div class="swiper-container" id="swiper-teams">
        <div class="swiper-wrapper">
            <?php while ( have_rows( 'team' ) ) :
		the_row(); 
		$team_name = get_sub_field( 'team_name' ); ?>
            ...
            <div class="swiper-slide">
                ...
                <div class="swiper-container swiper-team-container" id="swiper-team-<?php echo esc_html( $team_name ); ?>">
					...
					the_row(); ?>
                        <div class="swiper-slide">
                            <div class="team__cont">
								...
								if ( $zdjecie ) : ?>
                                <img class="team__photo" src="<?php echo esc_url( $zdjecie['url'] ); ?>"
                    ...
                    <div class="swiper-button-prev" id="swiper-button-prev-<?php echo esc_html( $team_name ); ?>"></div>
                    <div class="swiper-button-next" id="swiper-button-next-<?php echo esc_html( $team_name ); ?>"></div>

                    <!-- If we need scrollbar -->
                    <div class="swiper-scrollbar" id="swiper-scrollbar-<?php echo esc_html( $team_name ); ?>"></div>
                </div>
                <?php endif; ?>
            ...
            <script>
            const swiper<?php echo esc_html( $team_name ); ?> = new Swiper(
                '#swiper-team-<?php echo esc_html( $team_name ); ?>', {
                    slidesPerView: 1,
                    breakpoints: {
                        480: {
                            slidesPerView: 2,
                    ...
                    // Navigation arrows
                    navigation: {
                        nextEl: '#swiper-button-next-<?php echo esc_html( $team_name ); ?>',
                        prevEl: '#swiper-button-prev-<?php echo esc_html( $team_name ); ?>',
                    },

                    // And if we need scrollbar
                    scrollbar: {
                        el: '#swiper-scrollbar-<?php echo esc_html( $team_name ); ?>',
                        draggable: true,
                        dragSize: 28,
                        hide: false,
                    },
    ...
    <script>
        const swiperTeamsThumbs = new Swiper('#swiper-teamsThumbs', {
            slidesPerView: '<?php echo esc_html( $team_nr ); ?>',
            spaceBetween: 48,
            // centeredSlides: 'true',
        });
    </script>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-10 col-xl-5">
                <div class="streamers__circles-cont">
                    ...
                    <img class="streamers__circle--1" src="<?php echo esc_url( $streamers_photos_1['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_1['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_2 = get_sub_field( 'streamers_photos_2' );
						if ( $streamers_photos_2 ) : ?>
                    <img class="streamers__circle--2" src="<?php echo esc_url( $streamers_photos_2['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_2['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_3 = get_sub_field( 'streamers_photos_3' );
						if ( $streamers_photos_3 ) : ?>
                    <img class="streamers__circle--3" src="<?php echo esc_url( $streamers_photos_3['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_3['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_4 = get_sub_field( 'streamers_photos_4' );
						if ( $streamers_photos_4 ) : ?>
                    <img class="streamers__circle--4" src="<?php echo esc_url( $streamers_photos_4['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_4['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_5 = get_sub_field( 'streamers_photos_5' );
						if ( $streamers_photos_5 ) : ?>
                    <img class="streamers__circle--5" src="<?php echo esc_url( $streamers_photos_5['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_5['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_6 = get_sub_field( 'streamers_photos_6' );
						if ( $streamers_photos_6 ) : ?>
                    <img class="streamers__circle--6" src="<?php echo esc_url( $streamers_photos_6['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_6['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_7 = get_sub_field( 'streamers_photos_7' );
						if ( $streamers_photos_7 ) : ?>
                    <img class="streamers__circle--7" src="<?php echo esc_url( $streamers_photos_7['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_7['alt'] ); ?>" />
                    <?php endif; ?>

                    <?php
						$streamers_photos_8 = get_sub_field( 'streamers_photos_8' );
						if ( $streamers_photos_8 ) : ?>
                    <img class="streamers__circle--8" src="<?php echo esc_url( $streamers_photos_8['url'] ); ?>"
                        alt="<?php echo esc_attr( $streamers_photos_8['alt'] ); ?>" />
                    <?php endif; ?>
            ...
            <div class="col-lg-10 col-xl-6">
                <div class="streamers__text">
                    ...
                    <h1 class="glitch" data-text="<?php echo esc_html( $streamers_title ); ?>">
                        <?php echo esc_html( $streamers_title ); ?></h1>
                    <?php endif; ?>
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-6 mx-auto">
                <div class="shop__content">
                    ...
                    <h1 class="glitch" data-text="<?php echo esc_html( $shop_title ); ?>">
                        <?php echo esc_html( $shop_title ); ?></h1>
                    <?php endif; ?>
                    <p>
                    ...
                    <a href="<?php the_field('shop_address', 'option'); ?>"
                        class="links"><span><?php echo esc_html( $link_name ); ?></span></a>
